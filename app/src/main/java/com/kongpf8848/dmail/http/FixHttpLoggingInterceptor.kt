...
import com.chirpeur.chirpmail.api.server.isProbablyUtf8
import okhttp3.*
...
class FixHttpLoggingInterceptor @JvmOverloads constructor(
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (requestBody!=null) {
            if(requestBody.contentType()!=null){
                ...
                if(contentType.contains(MultipartBody.FORM.toString()) || contentType.contains("application/octet-stream")){
                    return chain.proceed(request)
                }
            }
        }
    ...
    private fun bodyHasUnknownEncoding(headers: Headers): Boolean {
        ...
        if (contentType!=null) {
             ...
             */
            return !(contentType.contains("text/plain") || contentType.contains("application/json") || contentType.contains("application/xml"))
        }
        //++++++++++++++++++++++++++++修改结束+++++++++++++++++++++++++++++++++++++++++++++
